...
class ReflowOvenControl():
    ...
    def __init__(self):
        self.relay1 = digitalio.DigitalInOut(board.D4)
        #self.relay2 = digitalio.DigitalInOut(board.D3)
    ...
    def enable(self, enable):
        try:
            self.relay1.value = enable
            #self.relay2.value = enable
            self.control = enable
            if enable:
                self.offtime = 0
        ...
        if oven.sensor_status:
            ...
            if oven.state != "ready" and time.monotonic() - second_timer >= 1.0:
                ...
                if oven_temp >= 50:
                    ...
                    file.write(str(timediff) + "," + str(oven_temp) + "\n")
