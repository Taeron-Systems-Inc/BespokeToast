...
# SPDX-FileCopyrightText: 2023 Taeron Systems Inc.
#
# SPDX-License-Identifier: MIT
#
# Derived from Adafruit's EZ Make Oven controller. See NOTICE.md.
            ...
            if cycle == 2:
                ...
                if firstCycle == True:
                    ...
                    self.draw_line(int((currentTemp[0] - iterProfileStartTime) / self.maxX * self.gxBuff),
                                   int((self.gyBuff - currentTemp[1]) / self.maxY * self.gyBuff) + 45,
                                   int((lastTemp[0] - iterProfileStartTime) / self.maxX * self.gxBuff),
                                   int((self.gyBuff - lastTemp[1]) / self.maxY * self.gyBuff) + 45,
                                   3)
